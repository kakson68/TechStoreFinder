...
class ServiceprovidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create serviceprovider" do
    assert_difference('Serviceprovider.count') do
      post serviceproviders_url, params: { serviceprovider: { description: @serviceprovider.description, rep: @serviceprovider.rep, title: @serviceprovider.title, url: @serviceprovider.url } }
    end
  ...
  test "should update serviceprovider" do
    patch serviceprovider_url(@serviceprovider), params: { serviceprovider: { description: @serviceprovider.description, rep: @serviceprovider.rep, title: @serviceprovider.title, url: @serviceprovider.url } }
